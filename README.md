...
The backend is responsible for data storage (MySQL database), user authentication and the leaderboard. It communicates via REST with the frontend. It is currently accessible through [mobbackend.elster.dev](https://mobbackend.elster.dev), but can also be hosted locally.\
